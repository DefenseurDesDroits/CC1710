...
switch($landingPage) {
  ...
  case 'MSP':
    ...
    break;
  case 'MLA':
    $title = "L'orientation et la protection des lanceurs d'alertes - Défenseur des droits";
    $opengraphtags = addOG('MLA', null, $opengraph);
    break;
  default:
